...
p.s. I am available for Freelance hire (UI design, web development). mail: addilarain00@gmail.com
...
$(function() {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const projectItems = document.querySelectorAll(".art-grid-item");
    ...
    filterLinks.forEach(link => {
      link.addEventListener("click", function (e) {
        ...
        // Remove active class
        filterLinks.forEach(l => l.classList.remove("art-current"));
        this.classList.add("art-current");
...
function showCustomAlert(message, isSuccess = true) {
  ...
  // Change colors based on success or error
  if (isSuccess) {
    alertBox.style.backgroundColor = "#11b823"
    alertBox.style.color = "#ffffff";
    alertBox.style.borderColor = "#11b823";
  } else {
...
(function () {
  emailjs.init("JGxbWKlfWjeLF_B6J"); // Your public key
})();
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      emailjs
        .sendForm("service_30wsr0g", "template_2hf6a2l", this)
        .then(() => {
          showCustomAlert("☑️ Message sent! Thank you for connecting.", true);
          form.reset(); // Clear the form after successful submit
        })
        .catch((error) => {
          console.error("❌ Error sending message:", error);
          showCustomAlert("Oops! Something went wrong. Please try again. ⚠️", false);
        });
    });
  }
});
